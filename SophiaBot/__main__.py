...
PM_START_TEXT = """
Hᴇʟʟᴏ Tᕼᴇʀᴇ! [️️ ️](https://telegra.ph/file/573723a2e75caae5ce99c.jpg) 💝, I'm Psylocke !
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", caption = [️️"My Telekinesis And Telepathy Powers are came to me Now 💫"]("https://telegra.ph/file/573723a2e75caae5ce99c.jpg")")
        except Unauthorized:
            LOGGER.warning(
